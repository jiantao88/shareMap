...
import com.fenxiangditu.sharemap.common.GlideApp;
...
public class ImageSelectedAdapter extends RecyclerView.Adapter<ImageSelectedAdapter.ViewHolder> implements View.OnClickListener {
    ...
    public void onBindViewHolder(@NonNull final ViewHolder holder, final int position) {
        if(getItemViewType(position)==TYPE_ADD){
            holder.mIv_selected.setImageResource(R.drawable.icon_add_img);
    ...
    public List<String> getSelectImages(){
        ...
        for(String str:list){
            ...
            if(str.startsWith("file:///")){
                ...
                //拍照
            }else if(str.startsWith("content://com.fenxiangditu.sharemap.fileprovider")){
