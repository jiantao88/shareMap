package com.jt.sharemap.ui.widget;
...
public class FabBehaviorOne extends CoordinatorLayout.Behavior<View> {
    FloatingActionButtonPlus mActionButtonPlus;

    public FabBehaviorOne(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
