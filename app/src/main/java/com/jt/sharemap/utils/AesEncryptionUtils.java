...
public class AesEncryptionUtils {
    ...
    private static final String KEY = "sharemap"; //随机源的种子
    ...
    public static SecretKeySpec createKey() {
        try {
            ...
            //根据字节数组生成AES专用密钥
            //返回AES密钥
            return getSecretKey(enCodeFormat);
    ...
    public static String encrypt(SecretKeySpec key, String content){
        ...
        } catch (NoSuchAlgorithmException | InvalidKeyException | BadPaddingException | UnsupportedEncodingException | IllegalBlockSizeException | NoSuchPaddingException e) {
            e.printStackTrace();
        }
        return null;
    }
